...
BLOG_AUTHOR = "Marty Henderson"  # (translatable)
BLOG_TITLE = "Demo Blog Site"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://demo.ravegrunt.is/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://demo.ravegrunt.is/"
BLOG_EMAIL = "marty@ravegrunt.is"
BLOG_DESCRIPTION = "Demo site for Pipeline Purposes"  # (translatable)
